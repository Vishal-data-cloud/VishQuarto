...
fig = px.sunburst(
    ...
    values='value',
    color='color',
    color_continuous_scale=custom_color_scale,  # Red-Yellow-Green scale
    range_color=[0, 100],  # Scale from 0% to 100%
    title='',
    width=800,
    height=800
)
